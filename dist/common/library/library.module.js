...
LibraryModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [validation_token_service_1.ValidationTokenApp, upload_1.UploadService],
        exports: [validation_token_service_1.ValidationTokenApp, upload_1.UploadService],
        controllers: [],
    })
], LibraryModule);
