...
const period_entity_1 = require("./period.entity");
const { STRING, INTEGER } = sequelize_typescript_1.DataType;
let SchoolEntity = class SchoolEntity extends sequelize_typescript_1.Model {
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number)
], SchoolEntity.prototype, "total_student", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        allowNull: true,
        type: STRING(2000),
...
__decorate([
    ...
    __metadata("design:type", String)
], SchoolEntity.prototype, "photo", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        allowNull: true,
        type: INTEGER,
    ...
    __metadata("design:type", Number)
], SchoolEntity.prototype, "id_period", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        allowNull: false,
        type: 'TIMESTAMP',
...
], SchoolEntity.prototype, "period", void 0);
